...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Dashboard with WON</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<c:url value = '/' /> " class="logo">
          ...
          <span class="logo-lg"><b>WON</b> PROJECT</span>
        </a>
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="<c:url value='/resources/dist/img/user7-128x128.jpg' />" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<c:url value='/member/logout'/>" class="btn btn-default btn-flat">Sign out</a>
                      <%-- <a href="<c:url value='/member/logout'/>" class="btn btn-default btn-flat">Sign out</a> --%>
                    </div>
                  </li>
                </ul>
